...
#
#   /spec/fixtures/responses/whois.melbourneit.com/status_registered.expected
#
...
require 'spec_helper'
require 'whois/record/parser/whois.melbourneit.com.rb'

describe Whois::Record::Parser::WhoisMelbourneitCom, "status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.melbourneit.com/status_registered.txt")
  ...
  describe "#created_on" do
    it do
      ...
      @parser.created_on.should == Time.parse("1999-04-05")
    end
  end
  describe "#updated_on" do
    it do
      @parser.updated_on.should be_a(Time)
      @parser.updated_on.should == Time.parse("2000-05-23")
    end
  end
  describe "#expires_on" do
    it do
      @parser.expires_on.should be_a(Time)
      @parser.expires_on.should == Time.parse("2021-04-05")
    end
  end
  ...
  describe "#admin_contacts" do
    it do
      ...
      @parser.admin_contacts[0].phone.should        == "+61.386242300"
      @parser.admin_contacts[0].fax.should          == nil
      @parser.admin_contacts[0].email.should        == "cdm@melbourneit.com.au"
    end
  end
  describe "#technical_contacts" do
    it do
      ...
      @parser.technical_contacts[0].phone.should        == "+61.386242300"
      @parser.technical_contacts[0].fax.should          == nil
      @parser.technical_contacts[0].email.should        == "cdm@melbourneit.com.au"
    end
  end
  describe "#nameservers" do
    it do
      ...
      @parser.nameservers[0].name.should == "ns1.melbourneit.com.au"
      @parser.nameservers[0].ipv4.should == nil
      @parser.nameservers[1].should be_a(Whois::Record::Nameserver)
      @parser.nameservers[1].name.should == "ns2.melbourneit.com.au"
